...
@Component({
  selector: 'app-ordersotr',
  templateUrl: './ordersotr.component.html',
  styleUrls: ['./ordersotr.component.less']
})
export class OrdersotrComponent implements OnInit {
  ...
  gettabledata(e?: boolean) {
    ...
    this.http.post('order/ordersotr', obj).subscribe((data: any) => {
