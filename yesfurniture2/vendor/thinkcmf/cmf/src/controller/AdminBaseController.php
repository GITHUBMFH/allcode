    ...
    protected function initialize()
    {
        ...
        if (!empty($sessionAdminId)) {
            ...
            if ($this->request->isPost()) {
                if (cmf_is_mobile()) {
                    if (cmf_is_ipad()) {
                        $this->error("您还没有登录！", url("myes/login/index"));
                    } else {
                        $this->error("您还没有登录！", url("yes/login/index"));
                    }
                } else {
                    $this->error("您还没有登录！", url("yes/login/index"));
                }
                ...
                if (cmf_is_mobile()) {
                    if (cmf_is_ipad()) {
                        return $this->redirect(url("yes/login/index"));
                    } else {
                        return $this->redirect(url("myes/login/index"));
                    }
                } else {
                    return $this->redirect(url("yes/login/index"));
                }
